( function( wp ) {
  ...
  const ICON = (window.ImperatoreThemeBlocks && window.ImperatoreThemeBlocks.iconsBase)
    ? window.ImperatoreThemeBlocks.iconsBase + 'pillar-enogastro.png'
    : '';

    registerBlockType('imperatore/pillar-enogastro', {
    attributes: {
    ...
    edit: function(props) {
      ...
      const blockProps = useBlockProps({ className: 'imp-pillar-block', 'data-key': 'enogastro' });
      ...
      return wp.element.createElement(wp.element.Fragment, null,
        ...
        wp.element.createElement(
          ...
          wp.element.createElement('div', { className: 'imp-pillar-block__label' }, 'ESPERIENZE ENOGASTRONOMICHE'),
    ...
    save: function(props) {
      ...
      return wp.element.createElement(
        'div',
        { className: 'imp-pillar-block', 'data-key': 'enogastro', 'data-percent': String(percent) },
        wp.element.createElement('div', { className: 'imp-pillar-block__icon' },
