( function( wp ) {
  ...
  const ICON = (window.ImperatoreThemeBlocks && window.ImperatoreThemeBlocks.iconsBase)
    ? window.ImperatoreThemeBlocks.iconsBase + 'pillar-cultura.png'
    : '';

    registerBlockType('imperatore/pillar-cultura', {
    attributes: {
    ...
    edit: function(props) {
      ...
      const blockProps = useBlockProps({ className: 'imp-pillar-block', 'data-key': 'cultura' });
      ...
      return wp.element.createElement(wp.element.Fragment, null,
        ...
        wp.element.createElement(
          ...
          wp.element.createElement('div', { className: 'imp-pillar-block__label' }, 'CULTURA'),
    ...
    save: function(props) {
      ...
      return wp.element.createElement(
        'div',
        { className: 'imp-pillar-block', 'data-key': 'cultura', 'data-percent': String(percent) },
        wp.element.createElement('div', { className: 'imp-pillar-block__icon' },
