( function( wp ) {
  ...
  const ICON = (window.ImperatoreThemeBlocks && window.ImperatoreThemeBlocks.iconsBase)
    ? window.ImperatoreThemeBlocks.iconsBase + 'pillar-natura.png'
    : '';

    registerBlockType('imperatore/pillar-natura', {
    attributes: {
    ...
    edit: function(props) {
      ...
      const blockProps = useBlockProps({ className: 'imp-pillar-block', 'data-key': 'natura' });
      ...
      return wp.element.createElement(wp.element.Fragment, null,
        ...
        wp.element.createElement(
          ...
          wp.element.createElement('div', { className: 'imp-pillar-block__label' }, 'NATURA & OUTDOORS'),
    ...
    save: function(props) {
      ...
      return wp.element.createElement(
        'div',
        { className: 'imp-pillar-block', 'data-key': 'natura', 'data-percent': String(percent) },
        wp.element.createElement('div', { className: 'imp-pillar-block__icon' },
